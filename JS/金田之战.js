			...
			var vector3 = new ol.layer.Vector({
				...
				// style: function(feature) {
				// 	style.getText().setText(feature.get('name')); //获取Geojson中的name
				// 	return style;
				// }
			});
			//用于加载矢量lake
